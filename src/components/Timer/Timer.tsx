...
const Timer:React.FC<TimerProps> = () => {
    ...
    return <div>
        {showTimer ? (
            <div className='flex items-center space-x-2 bg-[#333333] p-1.5 rounded hover:bg-[#292929]'>
                <div>{formatTime(time)}</div>
                <FiRefreshCcw className="cursor-pointer" onClick={() => {
                    setShowTimer(false);
                    setTime(0);
                }}/>
            </div>
            ...
            <div
					className='justify-end flex items-center p-1 h-8 hover:bg-[#292929] rounded cursor-pointer ml-auto'
